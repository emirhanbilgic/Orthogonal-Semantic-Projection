...
# Figure style: Times New Roman, axis labels only, no title or legend.
...
data_path = os.path.join(_OUT_DIR, 'cosine_vs_miou_correlation_all_methods_data.npz')
...
plt.tight_layout()
output_path = os.path.join(_OUT_DIR, 'cosine_vs_miou_binned_paper.pdf')
plt.savefig(output_path, bbox_inches='tight', facecolor='white')
output_path_png = os.path.join(_OUT_DIR, 'cosine_vs_miou_binned_paper.png')
