...
# ==============================================================================
# True Key-Space OMP Components (from benchmark_segmentation.py)
# ==============================================================================
...
def compute_gradcam_heatmap(model, image, text_emb_1x, layer_index: int = 8):
    ...
    Matches benchmark_segmentation.py's compute_gradcam_for_embedding.
    """
...
# batch_intersection_union removed (imported from benchmark_segmentation)
...
def compute_chefercam(model, image, text_emb_1x):
    ...
    Matches benchmark_segmentation.py's compute_chefercam.
    """
    import math
    from open_clip.timm_model import TimmModel
...
def compute_transformer_attribution(model, image, text_emb_1x, start_layer=1):
    ...
    Matches benchmark_segmentation.py's compute_transformer_attribution.
    """
    import math
    from open_clip.timm_model import TimmModel
...
class AntiHallucinationObjective:
    ...
    def __call__(self, trial: optuna.Trial):
        ...
        if self.baseline_metrics:
            ...
            # === COMPOSITE SCORE ===
            # Default objective is gap improvement: how much the (correct - wrong)
            # gap improves over the baseline, computed directly from current metrics.
            ...
            # Optional legacy mode: add a degradation term scaled by composite_lambda.
            if self.gap_only:
                pass
...
def main():
    ...
    # Load baseline from JSON if provided, otherwise use the hardcoded baseline.
