        ...
        for idx in iterator:
            try:
                ...
                def compute_metrics(text_emb_1x, prompt_text=None, method_name='legrad'):
                    ...
                    Matches benchmark_segmentation.py's metric computation.
                    """
                    if self.use_daam:
                    ...
                    # For other methods, normalize as per reference protocol (matching benchmark_segmentation.py)
                    ...
                    # Determine threshold (matching benchmark_segmentation.py)
